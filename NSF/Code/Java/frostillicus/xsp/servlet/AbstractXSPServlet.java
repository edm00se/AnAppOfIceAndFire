...
public abstract class AbstractXSPServlet extends DesignerFacesServlet {
	...
	protected abstract void doService(final HttpServletRequest req,
			final HttpServletResponse res, final FacesContext facesContext,
			final ServletOutputStream out) throws Exception;
}